/**
 * Poll additional PinGlass mockup tasks and download results
 */
...
const tasksPath = path.join(__dirname, '..', 'NewDesign', 'pinglass-additional-tasks.json');
...
async function pollAll(maxAttempts = 20) {
  ...
  if (completed.size === tasks.length) {
    ...
    console.log(`\n💡 Run again for more attempts: node scripts/poll-additional-mockups.js`);
  }
